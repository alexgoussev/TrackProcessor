/* is01d.f -- translated by f2c (version 20000817).
...
/* Subroutine */ int is01d_c(doublereal *x, doublereal *f, doublereal *df,
        integer *nx, doublereal *sm, doublereal *y, doublereal *c__,
        doublereal *rab, integer *ierr)
{
    /* Initialized data */
    ...
    static struct {
        doublereal e_1;
        } equiv_0 = { .3333333333333333 };

    static struct {
        doublereal e_1;
        } equiv_1 = { .6666666666666667 };
    ...
    /* Local variables */
#define oned3 ((doublereal *)&equiv_0)
#define twod3 ((doublereal *)&equiv_1)
    static doublereal e, g, h__;
    static integer i__, j;
#define sys037 ((doublereal *)&equiv_0)
#define sys038 ((doublereal *)&equiv_1)
    static doublereal p, onedh;
    extern /* Subroutine */ int utis11_c(integer *, integer *);
    static doublereal f2;
    static integer m2;
    static doublereal ff;
    static integer np1, np3;
    static doublereal hmg;
...
L3:
    ...
    for (i__ = 3; i__ <= i__1; ++i__) {
        ...
        rab_ref(1, i__) = one / (p * c___ref(1, i__ - 1) + rab_ref(4, i__) -
                ff * rab_ref(2, i__ - 1) - g * rab_ref(3, i__ - 2));
        rab_ref(6, i__) = y[i__] - rab_ref(2, i__ - 1) * rab_ref(6, i__ - 1)
                - rab_ref(3, i__ - 2) * rab_ref(6, i__ - 2);
        ff = p * c___ref(2, i__ - 1) + rab_ref(5, i__) - h__ *
                rab_ref(2, i__ - 1);
        g = h__;
